    ...
    >
      {collapsed ? (
        <div className="flex flex-col items-center gap-3">
          <Link
            href="/"
            className="flex h-9 w-9 items-center justify-center rounded-md bg-brand-600 text-white shadow-brand"
          ...
          <button
            ...
            className="focus-ring flex h-8 w-8 items-center justify-center rounded-md text-slate-500 hover:bg-brand-50 hover:text-brand-700"
          >
        ...
        <>
          <div className="flex items-center justify-between gap-2 px-2">
            <Link href="/" className="flex items-center gap-3" aria-label="Commute OS home">
              <div className="flex h-9 w-9 items-center justify-center rounded-md bg-brand-600 text-white shadow-brand">
                <CalendarClock className="h-5 w-5" />
              </div>
              <div>
            ...
            <button
              ...
              className="focus-ring flex h-8 w-8 shrink-0 items-center justify-center rounded-md text-slate-500 hover:bg-brand-50 hover:text-brand-700"
            >
