            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              {selected ? (
                <div className="flex gap-2">
                  <Link href={`/booking/${plan.trip_id}`} className="inline-flex h-10 items-center gap-2 rounded-md bg-brand-600 px-4 text-sm font-medium text-white shadow-brand hover:bg-brand-700">
